      ...
      <div className="bg-gray-800 border-b border-gray-700 mb-6">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center gap-4 h-16">
            <button onClick={() => navigate('/')} className="text-2xl font-bold text-purple-500">
              CineTix
            </button>
            <div className="flex-1">
              <h1 className="text-xl font-semibold text-gray-100">{decodeURIComponent(title || '')}</h1>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-4 pb-8">
        ...
        {step === 5 && (
          <div className="bg-gray-800 rounded-lg p-6 shadow-sm border border-gray-700">
            <h2 className="text-xl font-semibold mb-6 text-gray-100">Select Payment Method</h2>
            <PaymentMethods
            ...
            {paymentMethod && (
              <div className="mt-6">
                <h2 className="text-xl font-semibold mb-6 text-gray-100">Enter Payment Details</h2>
                <PaymentForms
